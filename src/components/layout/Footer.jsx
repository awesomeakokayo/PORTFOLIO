...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-base border-t border-border py-8 px-6">
      <div className="max-w-[1100px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        {/* Left Side: Copyright */}
        <p className="font-body text-[13px] text-text-muted text-center sm:text-left select-none">
          © 2026 Awesome Akokayo. Built with intention.
        </p>
